...
import { Images, Themes } from "@/app/lib/assets";
    ...
    <div className="flex flex-row w-full py-3 gap-[.625rem] items-start">
      ...
      <div className="flex flex-col flex-1 gap-1">
        <div className="card-content">
          <span className="text-black-80 font-bold text-base">{owner}</span>
        ...
        <div className="card-content text-sm">
          ...
          <span className="text-black-20 font-normal">{datetime}</span>
        </div>
      </div>
    </div>
  );
