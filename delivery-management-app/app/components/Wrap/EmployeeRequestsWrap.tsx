...
const EmployeeRequestsWrap = ({ id }: { id: string }) => {
  const {
    ...
    error,
    isLoading,
  } = useGetIssuesByEmployeeIdQuery(id, {
    pollingInterval: 10000,
    skipPollingIfUnfocused: true,
  });
  return (
    <div className="flex flex-col flex-[2_2_75%] bg-white shadow-sm rounded-lg p-3 gap-3 overflow-hidden">
      <h1 className="font-medium text-primary-100">EMPLOYEE REQUESTS</h1>
      {isLoading ? (
