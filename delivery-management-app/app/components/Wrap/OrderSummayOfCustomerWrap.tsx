...
const OrderSummayOfCustomerWrap = ({ id }: Props) => {
  const { data, isLoading } = useGetOrderSummaryOfCustomerQuery(id);

  return (
    <div className="bg-white rounded-lg p-3 flex flex-col items-center h-[60%] w-full">
...
export default OrderSummayOfCustomerWrap;
